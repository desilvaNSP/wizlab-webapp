                ...
                <div className="modal-detail__content">
                    <div className='form-group'>
                        ...
                        <div className='form-row'>
                            <div className='form-column'>
                                <div className='item-name'>Terminal Id</div>
                                <div className='item-dropdown'>
                                    <CustomDropdown defaultList={[]} onItemChange={(item) => {
                                    }} initValue={"1231"} required={true} editable={true} warningMessage={"Updating class is not allowed"} />
                                </div>
                            </div>
                            <div className='form-column'>
                                ...
                                <div className='item-dropdown'>
                                    <CustomDropdown defaultList={[]} onItemChange={(item) => {
                                    }} initValue={1} required={true} editable={true} warningMessage={"Updating class is not allowed"} />
                                </div>
                            </div>
                        </div>
                    </div>
